    ...
    <ext:GridPanel runat="server" Title="Fakülte Listesi" ID="grdList">
        <TopBar>
            <ext:Toolbar runat="server">
                <Items>
                    <ext:Button runat="server" id="btnNewFacult" icon="Add" text="Yeni Fakülte Kartı" ondirectclick="btnNewFacult_DirectClick"></ext:Button>
        ...
        <ColumnModel>
            <Columns>
                ...
                <ext:CommandColumn runat="server" Width="160" ID="grdCommands">
                    <Commands>
                        <ext:GridCommand Icon="ApplicationEdit" Text="Güncelle" CommandName="cmdUpdate">
                        </ext:GridCommand>
                        <ext:GridCommand Icon="Delete" Text="Sil" CommandName="cmdDelete">
                        </ext:GridCommand >
                    </Commands>
                    <DirectEvents>
